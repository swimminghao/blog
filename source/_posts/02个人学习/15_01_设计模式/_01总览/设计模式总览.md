...
tags:
  ...
  - 总览
categories: 技术
abbrlink: design-patterns-overvie
date: 2026-03-27 17:16:22
---
...
![image-20251123171202976](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/设计模式.jpg)
...
![image-20221002220740763](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/A0B8KX.png)
...
![image-20221003000126551](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/TrFmRB.png)
...
![image-20221003000746778](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/NmsISS.png)

现在我们来画一下上面`人喂动物的UML类图`，由于动物作为形参传入人类中，所以明显这是依赖关系，我们用虚线三角画即可

![image-20221003001510933](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/goEvXo.png)
...
![image-20221003003659847](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/5Jv0Og.png)
...
![image-20221003010625140](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/OxvNwA.png)
...
- 例如在用人体系，老板不应该直接管理众多的员工，如果过度依赖某些员工，势必会造成问题，一个好的公司不是靠人，而是靠制度、靠规范，应该让所有人依赖制度，老板只需要管理好制度，就能管理好所有人！这就是依赖倒置，在生活中这就叫`画饼！`
  ...
  ![image-20221003012933045](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/BzhE8H.png)
...
- 如果对于作为`返回类型、方法参数、成员属性、局部变量`的类，不需要过多的封装，应该提供应有的细节，由调用者自己弄清楚细节并承担异常的后果，这样由我们直接创造的对象，我们就能把它称为我们的朋友
  ...
  ![image-20221003132817525](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/fZuEiM.png)
...
![image-20221003140143641](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/s3fiFL.png)
...
![image-20221003000126551](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/LUqVZ3.png)
...
![image-20221003154018680](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/lrGK1h.png)
...
![image-20221003160116593](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/iP99WA.png)

点进源码中看我们发现，原来是继承了`Vector`类，让其拥有了链表的能力，看着这个兄弟设计模式也没学好

![image-20221003160243437](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/DK0kaf.png)

官方也意识到了这个设计不合理的地方，推荐我们使用Deque来实现栈

![image-20221003160720506](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/jp8iYj.png)

### 1.8 设计原则总结

![image-20221003155302341](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/R9ZVvY.png)
...
![image-20221003164956251](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/A3lw1R.png)
...
![image-20221003171512629](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/oanDh2.png)
...
![image-20221003182724048](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/0llHBw.png)

总结：

![image-20221003210806839](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/AxLb1G.png)
...
- 每一个层级的产品的产品都需要对应一个产品，不仅增加了编码的负担，还可能产生`类爆炸`的现象
  ...
  ![image-20221003210348599](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/wL23II.png)

**我们现在来画一下`工厂方法模式`的UML类图**：

![image-20221003205650960](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/moggkB.png)

**最后总结一下**：

![image-20221003210656801](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/QM7paU.png)
...
![image-20221003232555160](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/JPTdPG.png)
...
![image-20221003234528532](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/yZrksi.png)
...
- **产品等级**：其实要弄清楚产品的等级我们可以看下面的图，`产品等级就是指由一个接口或者父类泛化的子类`，例如各种饮料、各种电冰箱，而`产品簇`就是指由一个工厂生产的产品，看下图中美的生产的产品，这些就组成一个`产品簇`
  ...
  ![image-20221004000743736](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/jljkE9.png)
...
- **新增产品等级**：如果我们需要新加一个手机的`产品等级`呢？想想我们该如何添加，首先写一个抽象产品类，然后写？？等等，好像发现写不下去了叭，怎么好像又需要在其他的工厂里面添加自己的产品类？？又违反了`开闭原则`
  ...
  ![image-20221004001900063](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/4QQzd7.png)
...
![image-20221004150459347](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/cwBPdb.png)
...
![image-20221004014858663](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/4Cx8ym.png)
...
![image-20221004020426123](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/F8WKzy.png)
...
![image-20221004021050504](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/8qX7lc.png)
...
![image-20221004023115134](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/tiJCo3.png)
...
- 首先，用户添加`@Component`后，这个Bean的定义就被注册到IOC容器了，相当于简单工程中做映射；Bean工厂在创建这个实例时不需要知道具体类型，因为是靠反射创建的实例，无论什么类型都可以创建，这样就`消除了工厂类对接口实现类的依赖`，当我们想要拓展产品时，只需要写实现类并将其交给IOC容器即可
  ...
  ![image-20221004113108410](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/27/DzJxb4.png)
...
我们先来看下面的代码，目前我们将公共代码抽象成了`MenuComponent`

```java
package com.fx.structurePattren.composite.a;
 ...
 * @since 2025/11/9 14:35
 */
public class TestApp {
    public static void main(String[] args) {
        Menu menu = new Menu("湖南菜", "湖南人爱吃的菜");
        menu.add(new MenuItem("鸭", "永州血鸭"));
        menu.add(new MenuItem("蚂蚁上树", "永州血鸭"));
        Menu menu2 = new Menu("辣椒炒肉", "湖南人爱吃辣椒炒肉");
        /*
         * =====>>>>  cannot compile <=========
         * 因为现在的菜单只能添加菜单项，不能再添加其他菜单
         */
        // menu.add(menu2);
        menu.print("\t |--");
    }
    ...
    static class MenuComponent {
        ...
        public MenuComponent(String menuName, String description) {
            setName(menuName);
    ...
    static class MenuItem extends MenuComponent{
        public MenuItem(String menuName, String description) {
            super(menuName, description);
        }
        public void print(String prefix) {
...
优化后，核心点就是将print方法抽象到父类中，在menu递归时调用print方法会由子类进行实现，对应menu就会进行递归
...
public class TestApp {
    public static void main(String[] args) {
        Menu menu = new Menu("湖南菜", "湖南人爱吃的菜");
        menu.add(new MenuItem("鸭", "永州血鸭"));
        menu.add(new MenuItem("蚂蚁上树", "粉丝肉末"));

        Menu menu2 = new Menu("辣椒炒肉", "湖南人爱吃辣椒炒肉");
        menu2.add(new MenuItem("普通辣", "普通辣"));
        menu2.add(new MenuItem("爆辣", "爆辣"));

        Menu menu3 = new Menu("江西菜", "江西菜");
        menu3.add(new MenuItem("小炒黄牛肉", "鲜嫩可口"));
        menu3.add(new MenuItem("明基虾", "香辣美味"));

        menu2.add(menu3);
        menu.add(menu2);

        MenuItem mi3 = new MenuItem("剁椒鱼头", "经典湘菜");
        menu.add(mi3);
    ...
    static class Menu extends MenuComponent {
        ...
        public void print(String prefix) {
            // 使用前缀打印菜单名称
            System.out.println(prefix + "menu " + getName() + "--" + getDescription());

            // 为子项创建新的前缀（增加缩进）
            String newPrefix = prefix + "\t |--";
            // 下面会递归调用子项的print方法
            for (MenuComponent menuComponent : menuItemList) {
                menuComponent.print(newPrefix);
            }
        }
    }
