---
title: 小一文搞懂网络知识，IP、子网掩码、网关、DNS、端口
tags:
  - 网络
categories: 网络
abbrlink: 5a628c55
date: 2026-03-03 22:14:20
---
...
![img](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/03/Py00le.png)
...
## **IP 、[子网掩码](https://zhida.zhihu.com/search?content_id=102624204&content_type=Article&match_order=1&q=子网掩码&zhida_source=entity) 、[路由器](https://zhida.zhihu.com/search?content_id=102624204&content_type=Article&match_order=1&q=路由器&zhida_source=entity) 、[DNS](https://zhida.zhihu.com/search?content_id=102624204&content_type=Article&match_order=1&q=DNS&zhida_source=entity)**



![img](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/03/JXS1EY.png)



### **[IP地址](https://zhida.zhihu.com/search?content_id=102624204&content_type=Article&match_order=1&q=IP地址&zhida_source=entity)**

> IP地址是IP协议提供的一种统一的地址格式，它为互联网上的每一个网络和每一台主机分配一个逻辑地址，以此来屏蔽物理地址（每个机器都有一个编码，如MAC上就有一个叫[MAC地址](https://zhida.zhihu.com/search?content_id=102624204&content_type=Article&match_order=1&q=MAC地址&zhida_source=entity)的东西）的差异。是32位二进制数据，通常以十进制表示，并以“.”分隔。IP地址是一种逻辑地地址，用来标识网络中一个个主机，在本地局域网上是惟一的。



![img](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/03/unMjQe.png)
...
![img](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/03/Zk50X3.png)





![img](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/03/Wc9vCT.png)
...
![img](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/03/k5zcWg.png)
...
- 自动设置：自动设置就是利用[DHCP服务器](https://zhida.zhihu.com/search?content_id=102624204&content_type=Article&match_order=1&q=DHCP服务器&zhida_source=entity)来自动给网络中的电脑分配IP地址、子网掩码和默认网关。这样做的好处是一旦网络的默认网关发生了变化时，只要更改了DHCP服务器中默认网关的设置，那么网络中所有的电脑均获得了新的默认网关的IP地址。这种方法适用于网络规模较大、TCP/IP参数有可能变动的网络。另外一种自动获得网关的办法是通过安装代理服务器软件（如MS Proxy）的客户端程序来自动获得，其原理和方法和DHCP有相似之处。由于篇幅所限，就不再详述了。
...
![img](https://cdn.jsdelivr.net/gh/swimminghao/picture@main/img/2026/03/03/inoOX7.png)
